...
class ChartingState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	override function update(elapsed:Float)
	{
		...
		if(previewDad != null)
		{
			previewDad.x = previewDadAnchorX - previewDad.offset.x * previewDad.scale.x;
			previewDad.y = previewDadAnchorY - previewDad.offset.y * previewDad.scale.y;
		}
		if(previewTankman != null)
		{
			previewTankman.x = previewTankmanAnchorX - previewTankman.offset.x * previewTankman.scale.x;
			previewTankman.y = previewTankmanAnchorY - previewTankman.offset.y * previewTankman.scale.y;
		}
	...
	{
		super.beatHit();
		if(previewTankman != null) previewTankman.dance();
		if(previewDad != null) previewDad.dance();
	}
