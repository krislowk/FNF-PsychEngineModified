...
class ChartingState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	function loadPreviewCharacters():Void
	{
		...
		previewDad = new Character(0, 0, PlayState.SONG.player2, false);
		...
		previewDad.x = 20;
		previewDad.y = FlxG.height - previewDad.height - 20;
		add(previewDad);

		previewTankman = new Character(0, 0, PlayState.SONG.player1, true);
		...
		previewTankman.x = previewDad.x + previewDad.width - 20;
		previewTankman.y = FlxG.height - previewTankman.height - 20;
		add(previewTankman);
	}
